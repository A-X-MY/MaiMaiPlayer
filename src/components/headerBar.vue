...
<template>
	<div class="header">
		...
		<div class="header-profile" v-else>
			...
			<div class="logo">
				<a href="javascript:;" onclick="window.open('https://music.163.com/#/discover', '_blank')">
					<img src="../static/img/aplayer/logo.svg" alt="" class="Musicice" style="transform: scale(1.5);" />
				</a>
			</div>
		</div>
		<!-- 已登陆 -->
